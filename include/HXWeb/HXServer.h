 ...
 */
namespace HX::web { namespace Server {
    ...
    public:
         ...
         * @brief 建立连接
         */
        static AsyncFile asyncBind(AddressResolver::AddressInfo const &addr) {
        ...
        ~AsyncFile() {
            ...
            ::epoll_ctl(Server::EpollContext::get()._epfd, EPOLL_CTL_DEL, _fd, nullptr);
        }
    ...
    struct ConnectionHandler : std::enable_shared_from_this<ConnectionHandler> {
         ...
         */
        void read(std::size_t size = protocol::http::Request::BUF_SIZE);
    ...
    class Acceptor : public std::enable_shared_from_this<Acceptor> {
        ...
        AddressResolver::Address _addr; // 用于存放客户端的地址信息 (在::accept中由操作系统填写; 可复用)
